...
test("popup-open refreshes respect the configured polling interval", () => {
  ...
  assert.equal(Model.openRefreshMinimumAge({ stale: false }, "", 3600000), 3600000)
  assert.equal(Model.openRefreshMinimumAge(null, "", 3600000), 5000)
  assert.equal(Model.openRefreshMinimumAge({ stale: true }, "", 3600000), 5000)
  assert.equal(
    Model.openRefreshMinimumAge({ stale: false }, "request failed", 3600000),
    5000
  )
